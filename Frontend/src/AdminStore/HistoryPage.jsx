                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-0.5">
                              ...
                              {/* ─── 4. VIP Tag Logic (>5 appointments) ─── */}
                      ...
                      <td className="py-4 px-6">
                        <span
                          ...
                          ${customer.isVerified ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-rose-50 text-rose-700 border border-rose-200"}
                        `}
                        >
                          <span
                            className={`w-1.5 h-1.5 rounded-full ${customer.isVerified ? "bg-emerald-500" : "bg-rose-500"}`}
                          ></span>
                          {customer.isVerified}
                        </span>
                      </td>
