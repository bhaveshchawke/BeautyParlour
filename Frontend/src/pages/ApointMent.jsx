    ...
    <div className="bg-slate-50 min-h-screen font-sans pb-24">
      ...
      <section className="bg-slate-900 py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <span className="text-rose-400 font-bold tracking-[0.2em] uppercase text-[10px] sm:text-xs block mb-4 border border-rose-500/20 bg-rose-500/10 py-1.5 px-4 rounded-full w-fit mx-auto">
            Reserve Your Time
          </span>
          <h1 className="text-4xl lg:text-5xl font-light text-white tracking-tight mb-5">
            Book Your{" "}
            <span className="font-bold text-rose-500">Experience</span>
          </h1>
          <p className="text-slate-400 font-light text-sm lg:text-base max-w-lg mx-auto leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 overflow-hidden flex flex-col lg:flex-row border border-slate-100">
          ...
          <div className="w-full lg:w-3/5 p-6 sm:p-10 lg:p-14">
            ...
            <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className={`w-full pb-3 border-b bg-transparent text-slate-900 text-sm focus:outline-none focus:border-rose-500 transition-colors appearance-none cursor-pointer ${newError.selectedServiceError ? "border-red-400" : "border-slate-200"}`}
                  >
                  ...
                  <div className="absolute right-0 top-0 pointer-events-none text-slate-400">
                    ▼
                  </div>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pb-3 border-b bg-transparent text-slate-900 text-sm focus:outline-none focus:border-rose-500 transition-colors cursor-pointer ${newError.dateError ? "border-red-400" : "border-slate-200"}`}
                />
                {newError.dateError && (
                  <div className="text-[10px] text-red-500 font-medium mt-1.5">
                    {newError.dateError}
                ...
                <div className="flex flex-wrap gap-2.5">
                  {timeSlots.map((time, idx) => (
                    <div
                      ...
                      className={`px-5 py-2.5 border rounded-xl text-sm font-semibold cursor-pointer transition-all duration-300
                        ${
              ...
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 pt-4 border-t border-slate-100">
                <div className="w-full relative group">
                  <input
                    ...
                    value={data.fullName}
                    onChange={handleInputChange}
                    className={`w-full pb-3 border-b bg-transparent text-slate-900 text-sm focus:outline-none focus:border-rose-500 transition-colors peer placeholder-transparent ${newError.fullNameError ? "border-red-400" : "border-slate-200"}`}
                ...
                <div className="w-full relative group">
                  <input
                    ...
                    value={data.phone}
                    onChange={handleInputChange}
                    className={`w-full pb-3 border-b bg-transparent text-slate-900 text-sm focus:outline-none focus:border-rose-500 transition-colors peer placeholder-transparent ${newError.phoneError ? "border-red-400" : "border-slate-200"}`}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full mt-6 px-10 py-4 text-white text-sm font-bold rounded-full flex justify-center items-center gap-2 transition-all duration-300 active:scale-[0.98]
                  ${isLoading ? "bg-slate-400 cursor-not-allowed" : "bg-slate-900 hover:bg-rose-500 hover:shadow-lg hover:shadow-rose-500/30 cursor-pointer"}`}
              >
